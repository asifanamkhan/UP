...
class CreateBanijjikTaxPaymentsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('banijjik_tax_payments', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('banijjik_tax_payments');
    }
}
