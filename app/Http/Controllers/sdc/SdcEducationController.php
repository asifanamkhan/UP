...
class SdcEducationController extends Controller
{
    public function sdcEducation(){
        $edus = Education::all();
        return view('pages.front_end.sdc.education.talika',compact('edus'));
    }

    public function sdcEducationShow(Request $request){
        $columns = array(
            0 =>'id',
            1 => 'bname',
            2 => 'bfname',
