...
class SdcBloodGroupController extends Controller
{

    public function sdcBloodGroup(){
        return view('pages.front_end.sdc.blood_group.bloodGroup');
    }

    public function sdcBloodGroupShow(Request $request){
        $columns = array(
            0 =>'id',
            1 => 'bname',
            2 => 'bfname',
