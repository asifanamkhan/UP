...
class SdcNirokkhor15To45Controller extends Controller
{
    public function sdcNirokkhor15To45(){
        return view('pages.front_end.sdc.nirokkhor15To45.nirokkhor15To45');
    }

    public function sdcNirokkhor15To45Show(Request $request){
        $columns = array(
            0 =>'id',
            1 => 'bname',
            2 => 'bfname',
    ...
    public function sdc15To45NirokkhorChart(){
        $result = SdgChartCount::select('sakkhorBihin15To45Age','year')->get();
        $tax= Tax::where('sakkhorBihin',1)->count();
