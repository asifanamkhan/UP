...
class SdcPeshajibiController extends Controller
{
    public function sdcPeshajibi(){

        $occas = Occupation::all();
        return view('pages.front_end.sdc.peshajibi.talika',compact('occas'));
    }

    public function sdcPeshajibiShow(Request $request){
        $columns = array(
            0 =>'id',
            1 => 'bname',
            2 => 'bfname',
