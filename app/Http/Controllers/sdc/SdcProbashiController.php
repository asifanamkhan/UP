...
class SdcProbashiController extends Controller
{
    public function sdcProbashi(){
        return view('pages.front_end.sdc.probashi.talika');
    }

    public function sdcProbashiShow(Request $request){
    ...
    public function sdcProbashiChart(){
        $result = SdgChartCount::select('probashi','year')->get();
        $tax= Tax::where('probashi',1)->count();
