...
class SdcVumihinController extends Controller
{
    public function sdcVumihin(){
        return view('pages.front_end.sdc.vumihin.talika');
    }

    public function sdcVumihinShow(Request $request){
        $columns = array(
            0 =>'id',
            1 => 'bname',
            2 => 'bfname',
    ...
    public function sdcVumihinChart(){
        $result = SdgChartCount::select('vumihin','year')->get();
