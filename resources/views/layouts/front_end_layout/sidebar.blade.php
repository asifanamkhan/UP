...
<script src="owl-carousel/owl.carousel.js"></script><!-- all query are here end -->
<style type="text/css">
	#attend{
...
<div class="col-md-3 right_con"><!-- Right Content Start-->
	<div class="panel panel-primary"><!-- IMPORTANT Link Start-->
		<div class="panel-heading custom-heading" style="background-color:#004884;font-size: 13px;"><i class="fa fa-anchor"></i>&nbsp; ই-সেবা কেন্দ্র, ১নং গাজীপুর ইউন‌িয়ন পর‌িষদ</div>
		<div class="panel-body right-menu">
                    <span>
                        <i class="fa fa-hand-o-right"></i> &nbsp;
                        <a href="home/nagorikapplication.html">নাগরিকত্ব সনদের আবেদন ফরম</a>
                    </span>
			<span>
                        <i class="fa fa-hand-o-right"></i> &nbsp;
                        <a href="home/tradelicenseapplication.html">ট্রেড লাইসেন্স সনদের আবেদন ফরম</a>
                    </span>
			<span>
                        <i class="fa fa-hand-o-right"></i> &nbsp;
                        <a href="home/renewapplication.html">ট্রেড লাইসেন্স নবায়ন ফরম</a>
                    </span>
			<span>
                        <i class="fa fa-hand-o-right"></i> &nbsp;
                        <a href="home/oarishapplication.html">ওয়ারিশ সনদের আবেদন ফরম</a>
                    </span>
			<span>
                        <i class="fa fa-hand-o-right"></i> &nbsp;
	...
	<div class="panel panel-primary"><!-- IMPORTANT Link Start-->
		...
		<div class="panel-body right-menu">
                    <span>
                        <i class="fa fa-hand-o-right"></i> &nbsp;
                        <a href="home/filternagorikapplication.html">নাগরিকত্ব সনদের আবেদন যাচাই </a>
                    </span>
			<span>
                        <i class="fa fa-hand-o-right"></i> &nbsp;
                        <a href="home/filtertradeapplication.html">ট্রেড লাইসেন্স সনদের আবেদন যাচাই </a>
                    </span>
			<span>
                        <i class="fa fa-hand-o-right"></i> &nbsp;
                        <a href="home/filteroarishapplication.html">ওয়ারিশ সনদের আবেদন যাচাই </a>
                    </span>
			<span>
                        <i class="fa fa-hand-o-right"></i> &nbsp;
                        <a href="home/filterOtherServiceApplication.html">অন্যান্য সেবাসমূহর আবেদন  যাচাই</a>
                    </span>
		</div>
	</div><!-- IMPORTANT Link End-->
	...
	<div class="panel panel-primary"><!-- IMPORTANT Link Start-->
		...
		<div class="panel-body right-menu">
                    <span>
                        <i class="fa fa-hand-o-right"></i> &nbsp;
                        <a href="home/filternagorikcertificate.html">নাগরিক  সনদপত্র  যাচাই </a>
                    </span>
			<span>
                        <i class="fa fa-hand-o-right"></i> &nbsp;
                        <a href="home/filtertradecertificate.html">ট্রেড লাইসেন্স সনদপত্র  যাচাই </a>
                    </span>
			<span>
                        <i class="fa fa-hand-o-right"></i> &nbsp;
                        <a href="home/filteroarishcertificate.html">ওয়ারিশ সনদপত্র যাচাই </a>
                    </span>
			<span>
                        <i class="fa fa-hand-o-right"></i> &nbsp;
                        <a href="home/filterOtherServiceCertificate.html">অন্যান্য সেবাসমূহর সনদপত্র যাচাই </a>
                    </span>
			<span>
                        <i class="fa fa-hand-o-right"></i> &nbsp;
                        <a href="home/jacaiMamlaNotice.html">মামলার নোটিশ যাচাই</a>
                    </span>
			<span>
                        <i class="fa fa-hand-o-right"></i> &nbsp;
                        <a href="home/verify_holding_tax.html">হোল্ডিং ট্যাক্স যাচাই</a>
                    </span>
		</div>
