    ...
    <div class="panel panel-default mb-5">
        <div class="panel-body" >
            <div class="row">
                ...
                <div class="col-sm-12" style="margin-bottom:10px;margin-top:10px;">
                    <div class="form-group has-feedback">
                        <label for="Delivery-type" class="col-sm-3 control-label text-right">পেশা  <span style="color: red">*</span></label>
                        <div class="col-sm-8 has-feedback" id="">
                            <select name="occupation" id="occupation" class="form-control col-sm-8 js-example-basic-single text-left">
                                <option value="0">চিহ্নিত করুন</option>
                                @foreach($occas as $occa)
                                    @if($occa->status==1)
                                        <option value="{{$occa->id}}">{{$occa->	occupation}}</option>
                                    @endif
                                @endforeach
                            </select>
                        </div>
