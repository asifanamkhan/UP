...
@section('head_content')
    স্বাস্থ্য সম্মত স্যানিটেশন ব্যবহার না করা পরিবারের তালিকা
@endsection
@section('content')
...
@section('script')
    ...
    <script>
        var url = "{{route('sdcSanitationNaChart')}}";
        var Years = new Array();
        ...
        $(document).ready(function(){
            $.get(url, function(response){
                ...
                response[0].forEach(function(data){
                    ...
                    Labels.push(data.sastho_sommoto_sanitation_na_use);
                    Prices.push(data.sastho_sommoto_sanitation_na_use);
                });
                ...
                var myChart = new Chart(ctx, {
                    ...
                    data: {
                        labels:Years,
                        datasets: [{
                            label: 'স্বাস্থ্য সম্মত স্যানিটেশন ব্যবহার না করা পরিবারের সংখ্যা',
                            data: Prices,
                            borderWidth: 1,
