...
@section('script')
    ...
    <script>
        var url = "{{route('sdcHotoDoridroChart')}}";
        var Years = new Array();
            ...
            $.get(url,
                ...
                function(response){
                    ...
                    response[0].forEach(function(data){
                        ...
                        Labels.push(data.hoto_doridro_poribar);
                        Prices.push(data.hoto_doridro_poribar);
                    });
                    ...
                    var myChart = new Chart(ctx, {
                        ...
                        data: {
                            labels:Years,
                            datasets: [{
                                label: 'অতি দরিদ্র পরিবারের সংখ্যা',
                                data: Prices,
                                borderWidth: 1,
