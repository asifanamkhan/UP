        ...
        $(document).ready(function(){
            $.get(url,
                ...
                response[0].forEach(function(data){
                    ...
                    Labels.push(data.doridro_poribar);
                    Prices.push(data.doridro_poribar);
                });
