...
@section('script')
    ...
    <script>
        var url = "{{route('sdcBidhobaVataBonchitoChart')}}";
        var Years = new Array();
        ...
        $(document).ready(function(){
            $.get(url, function(response){
                ...
                response[0].forEach(function(data){
                    ...
                    Labels.push(data.bidhoba_vata_bonchito);
                    Prices.push(data.bidhoba_vata_bonchito);
                });
                ...
                var myChart = new Chart(ctx, {
                    ...
                    data: {
                        labels:Years,
                        datasets: [{
                            label: 'বিধবার ভাতা বঞ্চিতদের সংখ্যা',
                            data: Prices,
                            borderWidth: 1,
    ...
    <script>
        ...
        $('#submit').on('click',function () {
            ...
            $('#example'). DataTable( {
                ...
                "ajax":{
                    "url": "{{ route('sdcBidhobaVataBonchitoShow') }}",
                    "dataType": "json",
                    "type": "POST",
