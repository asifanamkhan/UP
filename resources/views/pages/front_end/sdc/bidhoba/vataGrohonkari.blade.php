...
@section('script')
    ...
    <script>
        var url = "{{route('sdcBidhobaVataGrohonChart')}}";
        var Years = new Array();
        ...
        $(document).ready(function(){
            $.get(url, function(response){
                ...
                response[0].forEach(function(data){
                    ...
                    Labels.push(data.bidhoba_vata_grohon);
                    Prices.push(data.bidhoba_vata_grohon);
                });
                ...
                var myChart = new Chart(ctx, {
                    ...
                    data: {
                        labels:Years,
                        datasets: [{
                            label: 'বিধবার ভাতা গ্রহণকারীর সংখ্যা',
                            data: Prices,
                            borderWidth: 1,
    ...
    <script>
        ...
        $('#submit').on('click',function () {
            ...
            $('#example'). DataTable( {
                ...
                "ajax":{
                    "url": "{{ route('sdcBidhobaVataGrohonShow') }}",
                    "dataType": "json",
                    "type": "POST",
