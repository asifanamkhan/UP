...
@section('head_content')
    পৃথক স্যানিটেশন ব্যবহার করা পরিবারের তালিকা
@endsection
@section('content')
...
@section('script')
    ...
    <script>
        var url = "{{route('sdcPrithokSanitationHaChart')}}";
        var Years = new Array();
        ...
        $(document).ready(function(){
            $.get(url, function(response){
                ...
                response[0].forEach(function(data){
                    ...
                    Labels.push(data.satitation_prithok_use);
                    Prices.push(data.satitation_prithok_use);
                });
                ...
                var myChart = new Chart(ctx, {
                    ...
                    data: {
                        labels:Years,
                        datasets: [{
                            label: 'পৃথক স্যানিটেশন ব্যবহার করা পরিবারের সংখ্যা',
                            data: Prices,
                            borderWidth: 1,
    ...
    <script>
        ...
        $('#submit').on('click',function () {
            ...
            $('#example'). DataTable( {
                ...
                "ajax":{
                    "url": "{{ route('sdcPrithokSanitationHaShow') }}",
                    "dataType": "json",
                    "type": "POST",
