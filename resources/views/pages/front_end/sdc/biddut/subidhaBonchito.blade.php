...
@section('head_content')
    বিদ্যুৎ সুবিধা বঞ্চিত পরিবারের তালিকা
@endsection
@section('content')
...
@section('script')
    ...
    <script>
        var url = "{{route('sdcBiddutBonchitoChart')}}";
        var Years = new Array();
        ...
        $(document).ready(function(){
            $.get(url, function(response){
                ...
                response[0].forEach(function(data){
                    ...
                    Labels.push(data.biddut_subidha_bonchito);
                    Prices.push(data.biddut_subidha_bonchito);
                });
                ...
                var myChart = new Chart(ctx, {
                    ...
                    data: {
                        labels:Years,
                        datasets: [{
                            label: 'িদ্যুৎ সুবিধা বঞ্চিত পরিবারের সংখ্যা',
                            data: Prices,
                            borderWidth: 1,
    ...
    <script>
        ...
        $('#submit').on('click',function () {
            ...
            $('#example'). DataTable( {
                ...
                "ajax":{
                    "url": "{{ route('sdcBiddutBonchitoShow') }}",
                    "dataType": "json",
                    "type": "POST",
