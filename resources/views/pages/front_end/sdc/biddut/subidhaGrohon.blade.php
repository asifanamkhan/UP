...
@section('head_content')
    বিদ্যুৎ সুবিধা গ্রহণকারীর পরিবারের তালিকা
@endsection
@section('content')
...
@section('script')
    ...
    <script>
        var url = "{{route('sdcBiddutGrohonChart')}}";
        var Years = new Array();
        ...
        $(document).ready(function(){
            $.get(url, function(response){
                ...
                response[0].forEach(function(data){
                    ...
                    Labels.push(data.biddut_subidha_grohon);
                    Prices.push(data.biddut_subidha_grohon);
                });
                ...
                var myChart = new Chart(ctx, {
                    ...
                    data: {
                        labels:Years,
                        datasets: [{
                            label: 'বিদ্যুৎ সুবিধা গ্রহণকারীর পরিবারের সংখ্যা',
                            data: Prices,
                            borderWidth: 1,
                            backgroundColor:['blue','red','green','yellow','#3C9C92'],
