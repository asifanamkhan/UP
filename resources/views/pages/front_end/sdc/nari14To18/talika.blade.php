...
@section('head_content')
    ১৪ থেকে ১৮ বছর বয়সী নারী তালিকা
@endsection
@section('content')
...
@section('script')
    ...
    <script>
        var url = "{{route('sdc14To18NariChart')}}";
        var Years = new Array();
        ...
        $(document).ready(function(){
            $.get(url, function(response){
                ...
                response[0].forEach(function(data){
                    ...
                    Labels.push(data.nari14To18);
                    Prices.push(data.nari14To18);
                });
                ...
                var myChart = new Chart(ctx, {
                    ...
                    data: {
                        labels:Years,
                        datasets: [{
                            label: '১৪ থেকে ১৮ বছর বয়সী নারী সংখ্যা',
                            data: Prices,
                            borderWidth: 1,
