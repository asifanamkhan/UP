...
@section('head_content')
    ইন্টারনেট সুবিধা পাওয়া পরিবারের তালিকা
@endsection
@section('content')
...
@section('script')
    ...
    <script>
        var url = "{{route('sdcInternetHaChart')}}";
        var Years = new Array();
        ...
        $(document).ready(function(){
            $.get(url, function(response){
                ...
                response[0].forEach(function(data){
                    ...
                    Labels.push(data.internate_subhidha_pawa);
                    Prices.push(data.internate_subhidha_pawa);
                });
                ...
                var myChart = new Chart(ctx, {
                    ...
                    data: {
                        labels:Years,
                        datasets: [{
                            label: 'ইন্টারনেট সুবিধা পাওয়া পরিবারের সংখ্যা',
                            data: Prices,
                            borderWidth: 1,
