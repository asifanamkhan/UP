...
@section('head_content')
    ০ থেকে ৫ বয়সী খর্বিত শিশুর তালিকা
@endsection
@section('content')
...
@section('script')
    ...
    <script>
        var url = "{{route('sdcKhorbitoShishuChart')}}";
        var Years = new Array();
        ...
        $(document).ready(function(){
            $.get(url, function(response){
                ...
                response[0].forEach(function(data){
                    ...
                    Labels.push(data.khorbito);
                    Prices.push(data.khorbito);
                });
                ...
                var myChart = new Chart(ctx, {
                    ...
                    data: {
                        labels:Years,
                        datasets: [{
                            label: '০ থেকে ৫ বয়সী খর্বিত শিশুর',
                            data: Prices,
                            borderWidth: 1,
                            backgroundColor:['blue','orange','green','yellow','#5D1A91'],
    ...
    <script>
        ...
        $('#submit').on('click',function () {
            ...
            $('#example'). DataTable( {
                ...
                "ajax":{
                    "url": "{{ route('sdc0To5AgeKhorbitoShishuShow') }}",
                    "dataType": "json",
                    "type": "POST",
