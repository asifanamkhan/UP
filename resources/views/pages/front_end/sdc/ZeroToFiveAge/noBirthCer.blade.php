...
@section('head_content')
    ০ থেকে ৫ বয়সী জন্ম নিবন্ধনহীন শিশুর তালিকা
@endsection
@section('content')
...
@section('script')
    ...
    <script>
        var url = "{{route('sdc0To5AgeNoBirthCerShishuChart')}}";
        var Years = new Array();
        ...
        $(document).ready(function(){
            $.get(url, function(response){
                ...
                response[0].forEach(function(data){
                    ...
                    Labels.push(data.No_birth_cer_0_to_5_age);
                    Prices.push(data.No_birth_cer_0_to_5_age);
                });
                ...
                var myChart = new Chart(ctx, {
                    ...
                    data: {
                        labels:Years,
                        datasets: [{
                            label: '০ থেকে ৫ বয়সী জন্ম নিবন্ধনহীন শিশুর সংখ্যা',
                            data: Prices,
                            borderWidth: 1,
    ...
    <script>
        ...
        $('#submit').on('click',function () {
            ...
            $('#example'). DataTable( {
                ...
                "ajax":{
                    "url": "{{ route('sdc0To5AgeNoBirthCerShishuShow') }}",
                    "dataType": "json",
                    "type": "POST",
