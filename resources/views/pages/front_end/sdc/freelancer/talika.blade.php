...
@section('script')
    ...
    <script>
        var url = "{{route('sdcFreelancerChart')}}";
        var Years = new Array();
        ...
        $(document).ready(function(){
            $.get(url, function(response){
                ...
                response[0].forEach(function(data){
                    ...
                    Labels.push(data.freelancer);
                    Prices.push(data.freelancer);
                });
