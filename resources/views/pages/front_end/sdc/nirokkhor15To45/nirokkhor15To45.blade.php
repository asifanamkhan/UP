...
@section('head_content')
    ১৫ থেকে ৪৫ বছর বয়সী স্বাক্ষরহীন কি না
@endsection
@section('content')
...
@section('script')
    ...
    <script>
        var url = "{{route('sdc15To45NirokkhorChart')}}";
        var Years = new Array();
        ...
        $(document).ready(function(){
            $.get(url, function(response){
                ...
                response[0].forEach(function(data){
                    ...
                    Labels.push(data.sakkhorBihin15To45Age);
                    Prices.push(data.sakkhorBihin15To45Age);
                });
                ...
                var myChart = new Chart(ctx, {
                    ...
                    data: {
                        labels:Years,
                        datasets: [{
                            label: ' ১৫ থেকে ৪৫ বছর বয়সী স্বাক্ষরহীন সংখ্যা',
                            data: Prices,
                            borderWidth: 1,
    ...
    <script>
        ...
        $('#submit').on('click',function () {
            ...
            $('#example'). DataTable( {
                ...
                "ajax":{
                    "url": "{{ route('sdcNirokkhor15To45Show') }}",
                    "dataType": "json",
                    "type": "POST",
