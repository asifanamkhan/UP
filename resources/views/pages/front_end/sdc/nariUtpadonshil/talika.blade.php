...
@section('head_content')
    নারী/পুরুষ উৎপাদনশীল কর্মজীবির তালিকা
@endsection
@section('content')
...
@section('script')
    ...
    <script>
        var url = "{{route('sdcNariKormojibiChart')}}";
        var Years = new Array();
        ...
        $(document).ready(function(){
            $.get(url, function(response){
                ...
                response[0].forEach(function(data){
                    ...
                    Labels.push(data.femaleMaleUtpadonshil);
                    Prices.push(data.femaleMaleUtpadonshil);
                });
                ...
                var myChart = new Chart(ctx, {
                    ...
                    data: {
                        labels:Years,
                        datasets: [{
                            label: 'নারী/পুরুষ উৎপাদনশীল কর্মজীবির',
                            data: Prices,
                            borderWidth: 1,
    ...
    <script>
        ...
        $('#submit').on('click',function () {
            ...
            $('#example'). DataTable( {
                ...
                "ajax":{
                    "url": "{{ route('sdcNariKormojibiShow') }}",
                    "dataType": "json",
                    "type": "POST",
