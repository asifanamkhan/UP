...
@section('head_content')
    নিরাপদ পানি পান না করা পরিবারের তালিকা
@endsection
@section('content')
...
@section('script')
    ...
    <script>
        var url = "{{route('sdcNirapodPaniNaPanChart')}}";
        var Years = new Array();
        ...
        $(document).ready(function(){
            $.get(url, function(response){
                ...
                response[0].forEach(function(data){
                    ...
                    Labels.push(data.nirapod_pani_pan_na_kora);
                    Prices.push(data.nirapod_pani_pan_na_kora);
                });
                ...
                var myChart = new Chart(ctx, {
                    ...
                    data: {
                        labels:Years,
                        datasets: [{
                            label: 'নিরাপদ পানি পান না করা পরিবারের সংখ্যা',
                            data: Prices,
                            borderWidth: 1,
    ...
    <script>
        ...
        $('#submit').on('click',function () {
            ...
            $('#example'). DataTable( {
                ...
                "ajax":{
                    "url": "{{ route('sdcNirapodPaniNaPanShow') }}",
                    "dataType": "json",
                    "type": "POST",
