...
@section('head_content')
    ১৫ থেকে ২৯ বছর বয়সী প্রশিক্ষণ প্রাপ্ত অশিক্ষিত বেকার তালিকা
@endsection
@section('content')
...
@section('script')
    ...
    <script>
        var url = "{{route('sdc15To29UnEduBekarChart')}}";
        var Years = new Array();
        ...
        $(document).ready(function(){
            $.get(url, function(response){
                ...
                response[0].forEach(function(data){
                    ...
                    Labels.push(data.oshikkhito_bekar);
                    Prices.push(data.oshikkhito_bekar);
                });
                ...
                var myChart = new Chart(ctx, {
                    ...
                    data: {
                        labels:Years,
                        datasets: [{
                            label: '১৫ থেকে ২৯ বছর বয়সী প্রশিক্ষণ প্রাপ্ত অশিক্ষিত বেকার তালিকা',
                            data: Prices,
                            borderWidth: 1,
    ...
    <script>
        ...
        $('#submit').on('click',function () {
            ...
            $('#example'). DataTable( {
                ...
                "ajax":{
                    "url": "{{ route('sdc15To29UnEduBekarShow') }}",
                    "dataType": "json",
                    "type": "POST",
