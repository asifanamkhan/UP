...
@section('script')
    ...
    <script>
        var url = "{{route('sdcOldVataGrohonChart')}}";
        var Years = new Array();
        ...
        $(document).ready(function(){
            $.get(url, function(response){
                ...
                response[0].forEach(function(data){
                    ...
                    Labels.push(data.old_vata_grohon);
                    Prices.push(data.old_vata_grohon);
                });
                ...
                var myChart = new Chart(ctx, {
                    ...
                    data: {
                        labels:Years,
                        datasets: [{
                            label: ' বয়স্ক ভাতা গ্রহণকারীর সংখ্যা',
                            data: Prices,
                            borderWidth: 1,
    ...
    <script>
        ...
        $('#submit').on('click',function () {
            ...
            $('#example'). DataTable( {
                ...
                "ajax":{
                    "url": "{{ route('sdcOldVataGrohonShow') }}",
                    "dataType": "json",
                    "type": "POST",
