...
@section('head_content')
    বয়স্ক ভাতার যোগ্য কিন্তু বঞ্চিত দের তালিকা
@endsection
@section('content')
...
@section('script')
    ...
    <script>
        var url = "{{route('sdcOldVataJoggoBonchitoChart')}}";
        var Years = new Array();
        ...
        $(document).ready(function(){
            $.get(url, function(response){
                ...
                response[0].forEach(function(data){
                    ...
                    Labels.push(data.old_vata_joggo_bonchito);
                    Prices.push(data.old_vata_joggo_bonchito);
                });
                ...
                var myChart = new Chart(ctx, {
                    ...
                    data: {
                        labels:Years,
                        datasets: [{
                            label: 'বয়স্ক ভাতার যোগ্য কিন্তু বঞ্চিত দের সংখ্যা',
                            data: Prices,
                            borderWidth: 1,
    ...
    <script>
        ...
        $('#submit').on('click',function () {
            ...
            $('#example'). DataTable( {
                ...
                "ajax":{
                    "url": "{{ route('sdcOldVataJoggoBonchitoShow') }}",
                    "dataType": "json",
                    "type": "POST",
