...
@section('script')
    ...
    <script>
        var url = "{{route('sdcOldVataBonchitoChart')}}";
        var Years = new Array();
        ...
        $(document).ready(function(){
            $.get(url, function(response){
                ...
                response[0].forEach(function(data){
                    ...
                    Labels.push(data.old_vata_bonchito);
                    Prices.push(data.old_vata_bonchito);
                });
                ...
                var myChart = new Chart(ctx, {
                    ...
                    data: {
                        labels:Years,
                        datasets: [{
                            label: 'বয়স্ক ভাতা বঞ্চিতদের সংখ্যা',
                            data: Prices,
                            borderWidth: 1,
    ...
    <script>
        ...
        $('#submit').on('click',function () {
            ...
            $('#example'). DataTable( {
                ...
                "ajax":{
                    "url": "{{ route('sdcOldVataBonchitoShow') }}",
                    "dataType": "json",
                    "type": "POST",
