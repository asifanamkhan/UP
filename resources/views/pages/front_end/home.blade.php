                ...
                <div id="demo">
                    <div class="row first-slide">
                        @foreach($members as $member)
                            @if($member->status==1)
                                @if($member->designation==1)
                                    <div style="display: inline-block">
                                        <a href="{{route('upMemberInfo',$member->id)}}">
                                            <img src="{{url("images/$member->image")}}"  class="img-responsive img-thumbnail" style="height: 100px; width: 120px;display: block">
                                            <span style="color: blue" >নাম: {{$member->name}}</span>
                                            <span  style="color: blue;display: block">পদবী: চেয়ারম্যান </span>
                                            <span style="color: blue;display: block">মোবাইল: {{$member->mob}}</span>
                                        </a>
                                    </div>
                                @endif
                            @endif
                    ...
                    <marquee behavior="scroll" align="middle" direction="left" scrollamount="4" onmouseover="this.stop()" onmouseout="this.start()">
                        <div class="row first-slide">
                            @foreach($members as $member)
                                @if($member->status==1)
                                    @if($member->designation==2)
                                        <a href="{{route('upMemberInfo',$member->id)}}">
                                            <div style="display: inline-block">
                                                <img src="{{url("images/$member->image")}}"  class="img-responsive img-thumbnail" style="height: 100px; width: 120px;display: block">
                                                <span style="color: blue" >নাম: {{$member->name}}</span>
                                                <span  style="color: blue;display: block">পদবী: মেম্বার </span>
                                                <span style="color: blue;display: block">মোবাইল: {{$member->mob}}</span>
                                            </div>
                                        </a>
                                    @endif
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <div class="row first-slide">
                        @foreach($members as $member)
                            @if($member->status==1)
                                @if($member->designation==3)
                                    <a href="{{route('upMemberInfo',$member->id)}}">
                                        <div style="display: inline-block">
                                            <img src="{{url("images/$member->image")}}"  class="img-responsive img-thumbnail" style="height: 100px; width: 120px;display: block">
                                            <span style="color: blue" >নাম: {{$member->name}}</span>
                                            <span  style="color: blue;display: block">পদবী: সচিব </span>
                                            <span style="color: blue;display: block">মোবাইল: {{$member->mob}}</span>
                                        </div>
                                    </a>
                                @endif
                    ...
                    <marquee behavior="scroll" align="middle" direction="left" scrollamount="4" onmouseover="this.stop()" onmouseout="this.start()">
                        <div class="row first-slide">
                            @foreach($members as $member)
                                @if($member->status==1)
                                    @if($member->designation==4)
                                        <a href="{{route('upMemberInfo',$member->id)}}">
                                            <div style="display: inline-block">
                                                <img src="{{url("images/$member->image")}}"  class="img-responsive img-thumbnail" style="height: 100px; width: 120px;display: block">
                                                <span style="color: blue" >নাম: {{$member->name}}</span>
                                                <span  style="color: blue;display: block">পদবী: গ্রাম পুলিশ </span>
                                                <span style="color: blue;display: block">মোবাইল: {{$member->mob}}</span>
                                            </div>
                                        </a>
                                    @endif
                    ...
                    <marquee behavior="scroll" align="middle" direction="left" scrollamount="4" onmouseover="this.stop()" onmouseout="this.start()">
                        <div class="row first-slide">
                            @foreach($members as $member)
                                @if($member->status==1)
                                    @if($member->designation==5)
                                        <a href="{{route('upMemberInfo',$member->id)}}">
                                            <div style="display: inline-block">
                                                <img src="{{url("images/$member->image")}}"  class="img-responsive img-thumbnail" style="height: 100px; width: 120px;display: block">
                                                <span style="color: blue" >নাম: {{$member->name}}</span>
                                                <span  style="color: blue;display: block">পদবী: উদ্যোক্তা </span>
                                                <span style="color: blue;display: block">মোবাইল: {{$member->mob}}</span>
                                            </div>
                                        </a>
                                    @endif
