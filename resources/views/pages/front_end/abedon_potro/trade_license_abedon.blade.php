            ...
            <div class="col-sm-12">
                <div class="form-group">
                    <div class="col-sm-3 col-sm-offset-9 ">
                        <input type="button" class="btn btn-primary" id='natun' name="ncompany" value='অন্যান্য মালিক' />
                    </div>
                </div>
            </div>
        </div>
    ...
    //Image
        ...
        // clearall
            ...
            $('#natun').on('click',function (e) {
                ...
                if(x<max_fields){
                    x++;
                    $('#clearall').append('<div id=""><button id="remove" style="margin-bottom: 15px" class="col-sm-0 col-sm-offset-11 btn btn-danger">remove</button>\n' +
                        '            <div class="row">\n' +
                        '                <div class="col-sm-12">\n' +
                        '                    <div class="form-group">\n' +
                        '                        <label for="Owner-name-english" class="col-sm-3 control-label">মালিকের নাম ( ইংরেজিতে )   <span style="color: red">*</span></label>\n' +
