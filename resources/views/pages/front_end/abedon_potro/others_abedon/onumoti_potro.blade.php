    ...
    <form action="{{route('others_sonod_abedon.store')}}" method="post" enctype="multipart/form-data" class="form-horizontal" name="upform" id="upform">
        ...
        <div class="row">
            <div class="col-sm-12" style="margin-bottom:10px;margin-top:10px;">
                <div class="form-group">
                    <label for="Service List" class="col-sm-3 control-label"> সেবা সমহু  <span style="color: red">*</span></label>
                    <div class="col-sm-3">
                    ...
                    @yield('form')
                    <label for="Delivery-type" class="col-sm-3 control-label"> সরবরাহের ধরণ </label>
                    <div class="col-sm-3">
        ...
        <div class="row">
            <div class="col-sm-6">
                <div class="form-group">
                    <label for="Work Placed" class="col-sm-5 control-label">কর্ম ক্ষেত্রের নাম</label>
                    <div class="col-sm-7">
                        <input type="text" name="workPlace" id="workPlace" class="form-control"  placeholder="অনুমতি পত্র এর জন্য! যেমন: পুলিশ" />
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    <label for="Birth-date" class="col-sm-6 control-label">জম্ম তারিখ </label>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="form-group">
                    ...
                    <label for="Name-bangla" class="col-sm-3 control-label">নাম ( বাংলায় )  <span style="color: red">*</span></label>
                    <div class="col-sm-3">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="form-group">
                    ...
                    <label for="Marital-status" class="col-sm-3 control-label">বৈবাহিক সম্পর্ক </label>
                    <div class="col-sm-3">
        ...
        <div class="row">
            <div class="col-sm-6">
                <div class="form-group">
                    <label for="Religion" class="col-sm-6 control-label">ধর্ম    </label>
                    <div class="col-sm-6">
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    <label for="Resident" class="col-sm-6 control-label">বাসিন্দা </label>
                    <div class="col-sm-6">
