                ...
                <div class="panel-body"  style="min-height:310px;">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row font-weight-bold">
                                ...
                                <div class="col-sm-6">
                                    <table class="table table-bordered table-hover">
                                        ...
                                        <tr>
                                            <th><b>বাৎসরিক করের পরিমান (টাকায়)</b></th>
                                            <td >{{$business_Type->amount}}</td>
                                        </tr>
                                        <tr>
                                            <th><b>সর্বমোট বকেয়া (টাকায়)</b></th>
                                            <td >{{$tax_amount}}</td>
                                        </tr>
                            ...
                            <form action="{{route('business_tax_payment')}}" method="POST" >
                                @csrf
                                <div class="row mt-5">
                                    <div class="col-sm-6 ">
                                        @php
                                    ...
                                    <div class="col-sm-5 text-right">
                                        ...
                                        <input type="hidden" name="roomNo" value="{{$payment->roomNo}}">
...
@section('script')
    <script>
        var amount = {{$business_Type->amount}}
