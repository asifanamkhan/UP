...
@section('content')
    ...
    <div class="panel panel-default">
        <div class="btn btn-info w-100" style=" color:white; background-color: #022241; font-size: 14px;text-align:center;"><b>ব্যবসায়ী ট্যাক্স অনাদায়ী তালিকা</b></div>
...
@section('script')
    ...
    <script>
        ...
        $('#search').on('click',function () {
            ...
            var href='business_Tax_onadaye_print'+'/'+word_no+'/'+last_tax_pay_date;
            ...
            $('#example'). DataTable( {
                ...
                "ajax":{
                    "url": "{{ route('BusinesstaxOandayeTalikaShow') }}",
                    "dataType": "json",
                    "type": "POST",
