...
@section('content')
    ...
    <div class="panel panel-default">
        <div class="btn btn-info w-100" style=" color:white; background-color: #022241; font-size: 14px;text-align:center;"><b>বাণিজ্যিক টেক্সধারীদের তালিকা</b></div>
...
@section('script')
    ...
    <script>
        ...
        $('#search').on('click',function () {
            ...
            var href='banijjik_Tax_print'+'/'+word_no;
            ...
            $('#example'). DataTable( {
                ...
                "ajax":{
                    "url": "{{ route('banijjikTaxDhariTalika') }}",
                    "dataType": "json",
                    "type": "POST",
