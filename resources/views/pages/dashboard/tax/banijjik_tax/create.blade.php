...
<div class="row">
    <div class="col-md-12">
        <div class="panel panel-primary">
            <div class="btn btn-info w-100" style=" color:white; background-color: #022241; font-size: 14px;text-align:center;"><b>বাণিজ্যিক কর আদায়</b></div>
                ...
                <div class="row">
                    <div class="col-md-12">
                                ...
                                <div class="row box" style="padding-bottom:20px;margin-top:10px; ">
                                    <div class="container">
                                        <ul class="nav nav-tabs font-weight-bold" id="myTab">
                                            <li class="active"><a data-toggle="tab" href="#banijjik_reg"  >বাণিজ্যিক কর রেজিস্ট্রেশন ফরম</a></li>
                                            <li class=""><a data-toggle="tab"  href="#banijjik_kor_aday"  >বাণিজ্যিক কর আদায়</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="tab-content">
                            ...
                            {{--বাণিজ্যিক কর রেজিস্ট্রেশন ফরম--}}
                            <div id="banijjik_reg"  class="tab-pane active text-right mt-3">
                                <div class="card">
                                    <div class="card-header text-center" style="background-color: #DDDDDD"><b>বাণিজ্যিক কর রেজিস্ট্রেশন ফরম</b></div>
                                    <div class="card-body">
                                        <form action="" method="" id="banijjik">
                                            <div class="row mt-5">
                                                <div class="col-sm-6">
                                                ...
                                                <div class="col-sm-6 mt-4">
                                                    ...
                                                    <input type="text" class="form-control col-sm-7" name="word_no" id="word_no" placeholder="ইংরেজিতে প্রদান করুন">
                                                </div>
                                                <div class="col-sm-6 mt-4">
                                                ...
                                                <div class="col-sm-6 mt-4">
                                                    <label for="" class="col-sm-5">রুমের সংখ্যা <span style="color: red">*</span></label>
                                                    <input type="number" class="form-control col-sm-7" name="room_no" id="room_no" placeholder="ইংরেজিতে প্রদান করুন">
                                                </div>
                                                <div class="col-sm-6 mt-4">
                                                    <label for="" class="col-sm-5">বাণিজ্যিক হোল্ডিং নং <span style="color: red">*</span></label>
                                                    <input type="text" class="form-control col-sm-7" name="holding_no" id="holding_no">
                                                </div>
                                                <div class="col-sm-6 mt-4">
                                                    <label for="" class="col-sm-5">মাসিক ভাড়া <span style="color: red">*</span></label>
                                                    <input type="number" class="form-control col-sm-7" name="mashik_vara" id="mashik_vara" placeholder="ইংরেজিতে প্রদান করুন">
                                                </div>
                                                ...
                                                <div class="col-sm-6 mt-4">
                                                    <label for="" class="col-sm-5">মোবাইল <span style="color: red">*</span></label>
                                                    <input type="text" class="form-control col-sm-7" name="mob" id="mob" placeholder="ইংরেজিতে প্রদান করুন">
                                                </div>
                                                <div class="col-sm-6 mt-4" style="color: red">
                                                    <label for="" class="col-sm-5">মাসিক ভাড়ার ট্যাক্স</label>
                                                    <input type="text" class="form-control col-sm-7" name="mashik_vara_tax" id="mashik_vara_tax" readonly>
                                                </div>
                                ...
                                <div  class="card mt-5 text-left" id="banijjik_kor_aday_table">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <button style="background-color: #022241;"class="w-100 btn btn-info mt-4">
                                            Commercial TAX Payment History
                                        </button>
...
@section('script')
    ...
    <script>
        ...
        $('#mashik_vara').on('keyup',function (e) {
           var x = ($('#mashik_vara').val()*12)*(7/100);
           console.log(x);
           $('#mashik_vara_tax').val(x.toFixed(2));
        });

        $('#loaderDiv').hide();
        $('#banijjik_kor_aday_table').hide();
        $('#banijjik').submit(function (e) {
            e.preventDefault();
            ...
            $.ajax({
                ...
                success:function (result) {
                    if (result==1) {
                        alert('আবেদনটি সফল ভাবে গৃহীত হয়েছে। (OK) প্রেস করুন');
                        $("#loaderDiv").hide();
                        $("#banijjik").show();
                        $('#banijjik').trigger("reset");
                    }
                }
            });
        });
                ...
                success:function (result) {
                    ...
                    if(result[0] == ''){
                        ...
                        kor.forEach(function (data) {
                            ...
                            $('#thottho').append( data.ownerBname+'  '+'এর তথ্য');
                            var holding_no = data.holding_no;
                            var word_no = data.word_no;


                            var banjjik = 'banijjik_holding_tax_pay/' + holding_no +'/'+ word_no +'/'+tax_amount;


                            var newTr = "<tr>";
                            newTr += "<tr class='tr'> <th><b>নাম</b></th>";
                            newTr += "<td class='font-weight-bold'>" + data.ownerBname + "</td>";
                            newTr += "</tr>";
                            ...
                            newTr += "<td class='font-weight-bold'>" + data.gram + "</td>";
                            newTr += "</tr>";
                            newTr += "<tr> <th><b>পোষ্ট অফিস</b></th>";
                            newTr += "<td class='font-weight-bold'>" + data.postOffice + "</td>";
                            newTr += "</tr>";
                            ...
                            newTr += "</tr>";
                            newTr += "<tr> <th><b>রুমের সংখ্যা</b></th>";
                            newTr += "<td class='font-weight-bold'>" + data.room_no + "</td>";
                            newTr += "</tr>";
                            newTr += "<tr> <th><b>মাসিক ভাড়া (টাকায়)</b></th>";
                            newTr += "<td class='font-weight-bold'>" + data.mashik_vara + "</td>";
                            newTr += "</tr>";
                            newTr += "<tr> <th><b>বাৎসরিক করের পরিমান (টাকায়)</b></th>";
                            newTr += "<td class='font-weight-bold'>" + data.mashik_vara_tax + "</td>";
                            newTr += "</tr>";
        ...
        $('#search').on('click',function () {
            ...
            $('#example'). DataTable( {
                ...
                "ajax":{
                    "url": "{{ route('banijjik_tax_pay_list') }}",
                    "dataType": "json",
                    "type": "POST",
