...
@section('content')
    <div class="row page-titles">
        <div class="col-md-6 col-8 align-self-center">
            <h3 class="text-themecolor mb-0 mt-0" style="color:white;">  নাগরিক  সনদ  গ্রহনকারীগণের তালিকা </h3>
            <ol class="breadcrumb">
                        ...
                        <div class="panel-body"  style="min-height:310px;">
                            <div class="row">
                                    ...
                                    <div class="col-md-5 mt-4">
                                        <button value="2" class="btn btn-info days_filter" >সর্বশেষ দুই দিন</button>
                                        <button value="7"  class="btn btn-success days_filter" >সর্বশেষ এক সপ্তাহ</button>
                                        <button value="30" class="btn btn-warning days_filter" >সর্বশেষ এক মাস</button>
                                        <button value="1" class="btn btn-danger days_filter" >সকল সনদ</button>
                                    </div>
                                <div class="col-md-12">
