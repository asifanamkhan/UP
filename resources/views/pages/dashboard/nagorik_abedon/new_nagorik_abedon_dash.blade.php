...
@section('content')
    <div class="row page-titles">
        <div class="col-md-6 col-8 align-self-center">
            <h3 class="text-themecolor mb-0 mt-0"> নাগরিক আবেদনকারীগণের তালিকা  </h3>
            <ol class="breadcrumb">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="panel panel-primary">
                <div class="panel-heading" style=" color:black; font-size: 20px;background:#40A291;text-align:center;"> নাগরিক আবেদনকারীগণের তালিকা  </div>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('#example'). DataTable( {
                ...
                "ajax":{
                    "url": "{{ route('NewagorikAbedonIndex') }}",
                    "dataType": "json",
                    "type": "POST",
