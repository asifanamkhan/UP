...
@section('content')
    <div class="panel panel-default mb-5">
        <div class="btn btn-info w-100" style=" color:white; background-color: #022241; font-size: 14px;text-align:center;"><b>শিক্ষার পদবী</b></div>
        <div class="panel-body" >
            <div class="col-sm-9">
                <div class="form-group has-feedback">
                    <label for="" class="col-sm-4 control-label text-right">নতুন শিক্ষার পদবী ধরন যোগ করুন <span style="color: red">*</span> </label>
                    <div class="col-sm-8">
                        <input type="text" name="education" id="name" class="form-control" placeholder="Ex: secondary school certificate(ssc)"/>
