...
@section('content')
    <div class="panel panel-default mb-5">
        <div class="btn btn-info w-100" style=" color:white; background-color: #022241; font-size: 14px;text-align:center;"><b>পরিবারের শ্রেণী </b></div>
        <div class="panel-body" >
            <div class="col-sm-9">
                <div class="form-group has-feedback">
                    <label for="" class="col-sm-4 control-label text-right">নতুন পরিবারের শ্রেণী ধরন যোগ করুন <span style="color: red">*</span> </label>
                    <div class="col-sm-8">
                        <input type="text" name="poribar_class" id="name" class="form-control" placeholder="Ex: একক"/>
    ...
    <div class="card mt-5">
        <div class="card-header text-center"><b>পরিবারের শ্রেণী এর তালিকা</b></div>
        <div class="card-body" >
...
@section('script')
    ...
    <script>
        ...
        $('#submit_button').on('click',function () {
            $.ajax({
                type:"POST",
                url:"{{route('familyClass.store')}}",
                data:{
                    'poribar_class':$('#name').val(),
                }
            });
