...
@section('content')
    <div class="panel panel-default mb-5">
        <div class="btn btn-info w-100" style=" color:white; background-color: #022241; font-size: 14px;text-align:center;"><b>পেশা</b></div>
        <div class="panel-body" >
            <div class="col-sm-9">
                <div class="form-group has-feedback">
                    <label for="" class="col-sm-4 control-label text-right">নতুন পেশা যোগ করুন<span style="color: red">*</span> </label>
                    <div class="col-sm-8">
                        <input type="text" name="occupation" id="name" class="form-control" placeholder="Ex: কৃষক"/>
    ...
    <div class="card mt-5">
        <div class="card-header text-center"><b>পেশার তালিকা</b></div>
        <div class="card-body" >
            ...
            $.ajax({
                ...
                success:function (result) {
                    if(result == 'something'){
                        ...
                        $('#name').parent().find('small').show().text('Occupation name is already exist');
            ...
            $.ajax({
                ...
                success: function (result) {
                    ...
                    if ($('#name').val() == '') {
                        ...
                        $('#name').parent().find('span').removeClass('glyphicon glyphicon-ok form-control-feedback');
                        $('#name').parent().find('span').addClass('glyphicon glyphicon-remove form-control-feedback');
                        $('#name').parent().find('small').show().text('Occupation name is required');
                        $('#submit_button').prop("disabled", true);
                    }
                    else if (result == 'two') {
                        $('#name').parent().removeClass('has-success');
