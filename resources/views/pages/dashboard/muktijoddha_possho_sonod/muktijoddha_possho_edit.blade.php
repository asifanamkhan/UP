            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="text" value="{{$othersSonodAbedon->mukti_name}}" name="mukti_name" id="mukti_name" class="form-control"  placeholder="" />
                            <
                        </div>
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="text" value="{{$othersSonodAbedon->gejet_no}}" name="gejet_no" id="gejet_no" class="form-control"  placeholder="ইংরেজিতে প্রদান করুন" />
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" value="{{$othersSonodAbedon->m_sonshod_sonod}}" name="m_sonshod_sonod" id="m_sonshod_sonod" class="form-control"  placeholder="" />
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="text" value="{{$othersSonodAbedon->sector}}" name="sector" id="sector" class="form-control"  placeholder="ইংরেজিতে প্রদান করুন" />
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="text" value="{{$othersSonodAbedon->mukti_sonod}}" name="mukti_sonod" id="mukti_sonod" class="form-control"  placeholder="ইংরেজিতে প্রদান করুন" />
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="text" value="{{$othersSonodAbedon->relation}}" name="relation" id="relation" class="form-control"  placeholder="যেমন: কন্যার পুত্র(নাতিন)" />
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="text" value="{{$othersSonodAbedon->short_rel}}" name="short_rel" id="short_rel" class="form-control"  placeholder="যেমন: দাদা/ নানা/" />
