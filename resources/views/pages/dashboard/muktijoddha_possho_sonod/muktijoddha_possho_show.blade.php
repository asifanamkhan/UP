...
@section('content')
    <div class="panel-body all-input-form" style="color:black">
        ...
        <div class="row">
            <div class="col-sm-6">
                <div class="form-group">
                    <label for="mukti name" class="col-sm-4 control-label">মুক্তিযোদ্ধার নাম</label>
                    {{$othersSonodAbedon->mukti_name}}
                </div>
            </div>
            <div class="col-sm-6">
                <div class="form-group">
                    <label for="gejet no" class="col-sm-4 control-label">গেজেট নং</label>
                    {{$othersSonodAbedon->gejet_no}}
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-sm-12">
                <div class="form-group">
                    ...
                    {{$othersSonodAbedon->m_sonshod_sonod}}
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-sm-6">
                <div class="form-group">
                    <label for="Sector No" class="col-sm-4 control-label">সেক্টর নং </label>
                    {{$othersSonodAbedon->sector}}
                </div>
            </div>
            <div class="col-sm-6">
                <div class="form-group">
                    <label for="Mukti sonod" class="col-sm-4 control-label">মুক্তিবার্তা নং </label>
                    {{$othersSonodAbedon->mukti_sonod}}
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-sm-6">
                <div class="form-group">
                    <label for="Sector No" class="col-sm-4 control-label">সমুক্তিযোদ্ধার সাথে সম্পর্ক </label>
                    {{$othersSonodAbedon->relation}}
                </div>
            </div>
            <div class="col-sm-6">
                <div class="form-group">
                    <label for="Mukti sonod" class="col-sm-4 control-label">সংক্ষেপে </label>
                    {{$othersSonodAbedon->short_rel}}
                </div>
            </div>
        </div>
        <div class="row">
