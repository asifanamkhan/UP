...
@section('content')
    <div class="row page-titles">
        <div class="col-md-6 col-8 align-self-center">
            <h3 class="text-themecolor mb-0 mt-0">মমুক্তিযোদ্ধা পোষ্য সনদ</h3>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{route('home')}}">Home</a></li>
                <li class="breadcrumb-item">অন্যান্য সেবাসমূহ</li>
                <li class="breadcrumb-item active">মুক্তিযোদ্ধা পোষ্য সনদ</li>
            </ol>
        </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="panel panel-primary">
                <div class="panel-heading" style=" color:black; font-size: 20px;background:#40A291;text-align:center;">মুক্তিযোদ্ধা পোষ্য সনদ</div>
        ...
        $(document).ready(function() {
            ...
            function load_data(is_days){
                ...
                $('#example'). DataTable( {
                    ...
                    "ajax":{
                        "url": "{{ route('muktijoddhaPosshoAbedon') }}",
                        "dataType": "json",
                        "type": "POST",
